...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, filename):
        ...
        img2 = pygame.image.load("explosion.png").convert()
        self.explosion_animation = Animation(img2, 30, 30)
    ...
    def update(self, horizontal_blocks, vertical_blocks):
        if not self.explosion:
            ...
            # detection with player and blocks
            ...
            if self.change_y > 0:
                ...
                if self.explosion_animation.index == self.explosion_animation.get_length() - 1:
                    ...
                    self.game_over = True
                self.explosion_animation.update(15)
...
class Animation(object):
    ...
    def get_image(self, x, y, width, height):
        ...
        image.blit(self.sprite_sheet, (x, y, width, height))
